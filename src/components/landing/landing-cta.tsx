      ...
      <div className="mx-auto max-w-6xl">
        <div className="rounded-2xl border border-[var(--landing-border)] bg-[var(--landing-surface)] px-6 py-14 text-center sm:px-12 sm:py-16">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <Link
              href="/sign-in"
              className="inline-flex h-11 w-full items-center justify-center rounded-lg border border-[var(--landing-border)] px-6 text-sm font-semibold text-[var(--landing-ink)] transition-colors hover:bg-[var(--landing-bg)] sm:w-auto"
            >
